...
void testApply1() {
  f(x) => 'p' + x;
  final e = listToEnum([['a', 'b'], ['c' , 'd']]);
  checkSame(apply(f, e), e.map(f));
}

void testApply2() {
  f(x, y) => x + y;
  final e1 = listToEnum([['a', 'b'], ['c' , 'd']]);
  final e2 = listToEnum([['e', 'f'], ['g', 'h']]);
  final empties = listToEnum([[], [], [], [], []]);
  checkSame(
      apply(f, e1, e2) + empties,
...
void testApply3() {
  ...
  final e1 = listToEnum([['a', 'b'], ['c' , 'd']]);
  final e2 = listToEnum([['e', 'f'], ['g', 'h']]);
  final e3 = listToEnum([['i', 'j'], ['k', 'l']]);
  final empties = listToEnum([[], [], [], [], [], [], []]);
  checkSame(
      apply(f, e1, e2, e3) + empties,
...
void testApply4() {
  ...
  final e2 = listToEnum([['e', 'f'], ['g', 'h']]);
  final e3 = listToEnum([['i', 'j'], ['k', 'l']]);
  final e4 = listToEnum([['m', 'n'], ['o', 'p']]);
  final empties = listToEnum([[], [], [], [], [], [], [], [], []]);
  checkSame(
      apply(f, e1, e2, e3, e4) + empties,
...
void testApply5() {
  ...
  final e3 = listToEnum([['i', 'j'], ['k', 'l']]);
  final e4 = listToEnum([['m', 'n'], ['o', 'p']]);
  final e5 = listToEnum([['q', 'r'], ['s', 't']]);
  final empties = listToEnum([[], [], [], [], [], [], [], [], [], [], []]);
  checkSame(
      apply(f, e1, e2, e3, e4, e5) + empties,
